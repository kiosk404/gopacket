...
const (
	...
	ExtPasswordSalt         Extension = 31
	ExtTicketPinning        Extension = 32
	ExtTlsCertWithExternPsk Extension = 33
	ExtSessionTicket        Extension = 35
	ExtPreSharedKey         Extension = 41
	ExtEarlyData            Extension = 42
	ExtSupportVersions      Extension = 43
...
var ExtensionReg = map[Extension]string{
	...
	ExtTicketPinning:        "ticket_pinning",
	ExtTlsCertWithExternPsk: "tls_cert_with_extern_psk",
	ExtSessionTicket:        "SessionTicket TLS",
	ExtPreSharedKey:         "pre shared key",
	ExtEarlyData:            "early data",
	ExtSupportVersions:      "support versions",
